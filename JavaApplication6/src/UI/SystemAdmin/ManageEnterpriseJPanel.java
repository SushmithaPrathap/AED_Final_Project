...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        for (Network network : system.getNetworkArray()) {
            for (Enterprise enterprise : network.getEnterpriseDir().getEnterpriseArray()) {
                ...
                row[2] = enterprise.getTypeEnterprise().getValue();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(245, 80, 660, 193));
        ...
        btnDelete.setBackground(new java.awt.Color(9, 87, 136));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 310, -1, -1));
        ...
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 310, 30));
