...
public class BookSelfAppointmentJPanel extends javax.swing.JPanel {
    ...
    public BookSelfAppointmentJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem system, Patient patient) {
        ...
        jLabel2.setText("Appointment Booking for " + patient.getNameVar());
        time=0;
        //populate doctor
    ...
    private void initComponents() {
        ...
        add(cmbDoctor, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 150, -1));
        ...
        add(txtBookAppointment, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 530, 230, -1));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 50, -1, 145));
        ...
        add(jpnael10, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 210, 90, -1));
        ...
        jLabel8.setForeground(new java.awt.Color(9, 87, 136));
        ...
        add(jpnael1014, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 298, 90, 60));
        ...
        jLabel9.setForeground(new java.awt.Color(9, 87, 136));
        ...
        add(jpnael15, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, 90, -1));
        ...
        jLabel11.setForeground(new java.awt.Color(9, 87, 136));
        ...
        add(jpnael11, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 210, 90, -1));
        ...
        jLabel12.setForeground(new java.awt.Color(9, 87, 136));
        ...
        add(jpnael12, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 300, 90, 60));
        ...
        add(jpnael16, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 380, 90, 60));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 10, 550, -1));
    ...
    private void txtBookAppointmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBookAppointmentActionPerformed
        ...
        if(enterprise.getTypeEnterprise().getValue().equals(Enterprise.EnterpriseType.Hospital.getValue())){
            for(Appointment appointment : patient.getApptDir().getApptList()){
            ...
            for(Appointment appointment : patient.getLabApptDir().getApptList()){
                if((appointment.getDate().compareTo(date1) == 0) && (appointment.getDoc().getID() == doctor.getID()) &&  !appointment.getStatus().equalsIgnoreCase(Appointment.AppointmentStatus.Cancel.getValue())){
                    JOptionPane.showMessageDialog(null, "Patient has already booked appointment!", "Warning", JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        if(enterprise.getTypeEnterprise().getValue().equals(Enterprise.EnterpriseType.Hospital.getValue())){
            appoint = patient.getApptDir().postAppointment(patient, doctor, date1 , (String)txtAppointmentType.getSelectedItem());
            appoint.setTime(time);
        }else if(enterprise.getTypeEnterprise().getValue().equals(Enterprise.EnterpriseType.Lab.getValue())){
            appoint = patient.getLabApptDir().postLabAppointment(patient, doctor, date1 , (String)txtAppointmentType.getSelectedItem());
            appoint.setTime(time);
        }
        Patient pt=null;
       ...
       {
           if(dept instanceof model.Organization.GeneralOrganization){
                drUserAcc = dept.getUserAcctDir().getUserAccByEmp(doctor);
       ...
       //Integer [] arr = null;
        ...
        if(enterprise.getTypeEnterprise().getValue().equals(Enterprise.EnterpriseType.Lab.getValue())){
            LabTechWorkRequest workreq = new LabTechWorkRequest();
                ...
                labTest.setNameVar("none");
                labTest.setDoc(appoint.getDoc());
                labTest.setStatusVar("New");
                //labTest.setType(testType);
                workreq.setLabTest(labTest);
                appoint.getLabTestArray().addLabTest(labTest);
                appoint.setStatus(Appointment.AppointmentStatus.MarkforTest.getValue());
